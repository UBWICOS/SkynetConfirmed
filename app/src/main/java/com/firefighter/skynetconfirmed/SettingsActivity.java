...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || MSHQPreferenceFragment.class.getName().equals(fragmentName);
    }
    ...
    public static class MessagesPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("keywords_text"));
            bindPreferenceSummaryToValue(findPreference("message_address_text"));
        }
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_phonecalls);
            setHasOptionsMenu(true);
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class MSHQPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_mshq);
            setHasOptionsMenu(true);
